...
//        regex4_remplacerLesMatchs();
    ...
    private void regex1_correspondExactement() {
        ...
        for (String[] test : tabTests) {
            ...
            correspondExactement = correspondExactement_PatternCompile(strRegex, str);
            System.out.println(strResultat + correspondExactement);

            correspondExactement = Pattern.matches(strRegex, str);
            System.out.println(strResultat + correspondExactement);

            correspondExactement = str.matches(strRegex);
            System.out.println(strResultat + correspondExactement);

            correspondExactement = estDansUneChaine_PatternCompile('^' + strRegex + '$', str);
            System.out.println(strResultat + correspondExactement);
        }
    }
